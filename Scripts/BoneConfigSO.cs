...
namespace Rigr
{
    ...
    public class BoneConfigSO : ScriptableObject
    {
        ...
        [SerializeField] private BoneSideLerpMethodDictionary m_boneToLerpMethodDict =
            new BoneSideLerpMethodDictionary()
            {
        ...
        [SerializeField] private float m_lipMovementWidth = 1.0f;
        [SerializeField] private float m_lipMovementHeight = 1.0f;
        // [SerializeField] private float m_outerMouthWidth = 1.0f;
        ...
        public float LipMovementWidth => m_lipMovementWidth;

        public float LipMovementHeight => m_lipMovementHeight;
