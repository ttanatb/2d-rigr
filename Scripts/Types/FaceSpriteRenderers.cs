...
namespace Rigr
{
    ...
    public struct FaceSpriteRenderers
    {
        ...
        {
            LEyeBrow = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Eyebrow, BoneConfigSO.Side.Left),
                    root)
                ?.TryGetComponent(out LEyeBrow);
            REyeBrow = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Eyebrow, BoneConfigSO.Side.Right),
                    root)
                ?.TryGetComponent(out REyeBrow);
            LWhiteEye = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.WhiteEye, BoneConfigSO.Side.Left),
                    root)
            ...
            LEyeball = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Eyeball, BoneConfigSO.Side.Left),
                    root)
                ?.TryGetComponent(out LEyeball);
            REyeball = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Eyeball, BoneConfigSO.Side.Right),
                    root)
            ...
            Nose = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Nose), root)
                ?.TryGetComponent(out Nose);
            Mouth = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Mouth), root)
                ?.TryGetComponent(out Mouth);
            Face = null;
            BoneFinder.FindBoneWithName(boneConfig.GetName(BoneConfigSO.SpriteName.Face), root)
                ?.TryGetComponent(out Face);
        }
    }
}
